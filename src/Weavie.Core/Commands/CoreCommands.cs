...
public static class CoreCommands {
	...
	/// <summary>Peeks the definition of the symbol at the editor cursor in an inline view (the editor right-click "Peek Definition"); bound to <c>Alt+F12</c> and Mod+Alt+Click.</summary>
	...
	public static void Register(CommandRegistry registry) {
		...
		registry.Register(new CommandDefinition {
			...
			Description = "Show the definition of the symbol at the editor cursor in an inline peek view without "
				+ "leaving the file; Mod+Alt+Click a symbol does the same. Does nothing when no definition is known "
