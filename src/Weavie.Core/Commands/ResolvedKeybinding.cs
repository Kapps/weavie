...
/// <summary>
/// One effective key binding after merging command defaults with the user's <c>~/.weavie/keybindings.json</c>.
/// Shipped to the web (which resolves keydowns against it) and surfaced in <c>listCommands</c>.
/// <see cref="Key"/> keeps the tinykeys-style <c>$mod</c> form; the web formats it.
/// </summary>
