...
/// <summary>
/// The editor state persisted with one session slot: <see cref="Open"/> files and which is <see cref="Active"/>.
/// Distinct from <see cref="ActiveEditor"/> (the <em>live</em> editor for the MCP server). See
