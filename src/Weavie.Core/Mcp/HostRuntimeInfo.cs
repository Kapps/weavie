...
/// <summary>
/// The running host's identity, surfaced to embedded agents in their Weavie guidance
/// (<see cref="EmbeddedAgentGuidance.Compose"/>): how it's reached (<see cref="Transport"/>), whether it's a
