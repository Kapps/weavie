...
internal static class SourceJson {
	/// <summary>The string value of <paramref name="name"/> on <paramref name="element"/>, or empty when the element
	/// isn't an object or the property is absent/non-string.</summary>
