...
internal static partial class NativeMethods {
	...
	// Linux spawn path; macOS uses the native launcher.
	...
	// Spawns the isolated native launcher; argv includes the target executable. Negative errno on failure.
	...
	internal static partial int weavie_pty_spawn(
		string launcher, IntPtr argv, IntPtr envp, string? cwd, ushort rows, ushort cols, out int master, out int pid);
