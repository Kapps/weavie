...
/// <summary>
/// Thrown by <see cref="WorktreeManager.RemoveAsync"/> when git no longer tracks a worktree whose directory
/// remains on disk OUTSIDE the managed worktrees dir, so Weavie won't delete the unowned path itself and the
/// user must remove it by hand. (A half-removed worktree inside the managed dir is deleted automatically.)
/// </summary>
