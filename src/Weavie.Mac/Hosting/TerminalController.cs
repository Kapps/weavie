...
public sealed class TerminalController : IDisposable {
	...
	/// <summary>Creates a controller that streams PTY output to (and input from) the given bridge.</summary>
	...
	/// <summary>
	/// Spawns the login shell that execs the interactive claude (at the given size) and begins
	/// relaying its output to the web view. No-op if already started.
	/// </summary>
