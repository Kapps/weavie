...
/// <summary>
/// Win32 chrome tweaks the WinForms API doesn't expose — the immersive dark title bar (via DWM), so the
/// window caption matches the dark app instead of the default light frame.
/// </summary>
