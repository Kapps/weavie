...
/// <summary>
/// Win32 chrome tweaks WinForms doesn't expose — the immersive dark title bar (via DWM), so the caption
/// matches the dark app instead of the default light frame.
/// </summary>
