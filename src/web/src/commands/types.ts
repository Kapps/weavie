...
export const CommandIds = {
  ...
  spellingShowActions: "weavie.spelling.showActions",
  spellingAddToProjectDictionary: "weavie.spelling.addToProjectDictionary",
  spellingAddToUserDictionary: "weavie.spelling.addToUserDictionary",
  spellingApplySuggestion: "weavie.spelling.applySuggestion",
