...
export type CommandOwner = "backend" | "client";
...
export const CommandIds = {
  ...
  newTerminal: "weavie.terminal.new",
  closeTerminal: "weavie.terminal.close",
  closeTerminalPrompt: "weavie.terminal.closePrompt",
  nextTerminalTab: "weavie.terminal.nextTab",
  ...
  gettingStarted: "weavie.gettingStarted.open",
  ...
  agentDeclineInput: "weavie.agent.declineInput",
  agentCancelInput: "weavie.agent.cancelInput",
  agentAcceptInput: "weavie.agent.acceptInput",
  agentAuthenticate: "weavie.agent.authenticate",
  ...
  openRecentWorkspace: "weavie.workspace.openRecent",
  closeWindow: "weavie.window.close",
  exit: "weavie.window.exit",
